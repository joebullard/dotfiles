...
export HOMEDEV=$HOME/dev
alias cdd='cd $HOMEDEV'
...
# to use iPython in virtualenv easily
...
alias dmgo='docker-machine start default && eval "$(docker-machine env default)"'

for cmd in {ps,stop,rm,rmi,exec}; do
